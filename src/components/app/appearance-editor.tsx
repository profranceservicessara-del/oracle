...
// usado tanto em Cobrança › Personalizar fatura quanto em Configurações.
// Frontend-only: toda a customização vive em estado (sem persistência ainda).
// Preview com dados de exemplo. "Salvar" mantém a seleção atual + toast.
// ---------------------------------------------------------------------------
