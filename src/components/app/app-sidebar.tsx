...
const icons = {
  dashboard: (
    <svg {...s18}><rect height="8" rx="1.5" width="8" x="3" y="3" /><rect height="8" rx="1.5" width="8" x="13" y="3" /><rect height="8" rx="1.5" width="8" x="13" y="13" /><rect height="8" rx="1.5" width="8" x="3" y="13" /></svg>
  ),
  documentos: (
